...
# a PowerShell script.
$computers = "C:\Users\stopete\source\repos\InvokePowerShellScript\InvokePowerShellScript\bin\Debug\net8.0-windows\InvokeCommandFiles\Computers\ActiveComputers.txt"
$scriptfile = "C:\Users\stopete\source\repos\InvokePowerShellScript\InvokePowerShellScript\bin\Debug\net8.0-windows\InvokeCommandFiles\Scripts\RemoveProfilesNotLoadedNotSpecial.ps1"
